...
const Product = ({uid, item, favProductList, setFavProductList, getFavProducts, openSnackBar,setOpenSnackBar, snackBarMsg, setSnackBarMsg}) => {
    ...
    return (
        <Container >
            ...
            <Info>
                <Icon>
                    <ShoppingCartIcon style={{color:"#2F2D3F"} } onClick={()=>{
                        if(uid !== 0){
                            addItem({
                                id: item.product_id, 
                                quantity: 1, 
